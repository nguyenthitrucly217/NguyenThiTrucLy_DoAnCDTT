...
function PageList() {
    ...
    useEffect(function(){
        (async function(){
            await postservice.get_byPagePa(8,page).then(function(result){
    ...
    function postDelete(id){
        postservice.deletetam(id).then(function(result){
        ...
        <div className="card">
            <div className="card-header">
                <div className="row">
                    ...
                    <Link className="btn btn-sm btn-success me-1" to={"/admin/page/xoa"}>
                            <FaTrash />
                        </Link>
