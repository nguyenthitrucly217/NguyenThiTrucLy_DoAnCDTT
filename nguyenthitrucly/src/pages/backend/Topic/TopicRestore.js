...
function TopicRestore() {
    ...
    useEffect(function(){
        (async function(){
            await topicservice.getlistRestore(4,page).then(function(result)
            {
             ...
             <div className="card-header">
                <div className="row">
                    ...
                    <div className="col-6 text-end">
                        <Link className=" btn btn-sm btn-success" to="/admin/topic">
                            Về danh sách
                        </Link>
                    </div>
                 ...
                 <tbody>
                    {topics.map(function(topic,index){
                        return( <tr key={index}>
                            ...
                            <td>
                            <button  onClick={()=>topicRestore(topic.id)} className="btn btn-sm btn-danger me-1"><FaTrashRestore/></button>
