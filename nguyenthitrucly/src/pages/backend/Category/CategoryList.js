...
function CategoryList() {
    ...
    useEffect(function(){
        (async function(){
            await categoryservice.get_byPageCa(4,page).then(function(result){
    ...
    function categoryDelete(id){
        categoryservice.deletetam(id).then(function(result){
        ...
        <div className="card">
            <div className="card-header">
                <div className="row">
                    ...
                    <Link className="btn btn-sm btn-success me-1" to={"/admin/category/xoa"}>
                            <FaTrash />
                        </Link>
