...
function Information() {
    ...
    async function informationadd(event) {
        ...
        try {
            await orderservice.Information(order)
                .then(function (res) {
                    if (res.data.success === true) {
                        ...
                        alert(res.data.message);
                        navigate('/thong-tin', { replace: true });
                    }
                });
        } catch (error) {
            console.error(error);
                ...
                <div className="login col-5 mt-3 mb-3">
                    ...
                    <div className="from-login">
                        <div class="form-container">
                            <p class="title-register text-white">Thông tin khách hàng</p>
                            <form onSubmit={informationadd} method="" >
                                ...
                                <div class="mb-3"></div>
                                <button type="submit"class="sign text-center">Xác nhận mua hàng</button>
                            </form>
